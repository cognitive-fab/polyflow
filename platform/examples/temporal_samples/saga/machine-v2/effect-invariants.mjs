...
const COMPLETIONS = { ACCOUNT_CREATED: 'createAccount', ACCOUNT_FAILED: 'createAccount', ADDRESS_ADDED: 'addAddress', ADDRESS_FAILED: 'addAddress', CLIENT_ADDED: 'addClient', CLIENT_FAILED: 'addClient', BANK_ADDED: 'addBankAccount', BANK_FAILED: 'addBankAccount', KYC_PASSED: 'addKycCheck', KYC_FAILED: 'addKycCheck', BANK_DISCONNECTED: 'disconnectBankAccounts', BANK_DISCONNECT_FAILED: 'disconnectBankAccounts', CLIENT_REMOVED: 'removeClient', CLIENT_REMOVE_FAILED: 'removeClient', ADDRESSES_CLEARED: 'clearPostalAddresses', ADDRESSES_CLEAR_FAILED: 'clearPostalAddresses' };
// [a compensation, the success that makes a later compensation due first, that compensation]
const DUE_FIRST = [['clearPostalAddresses', 'CLIENT_ADDED', 'removeClient'], ['removeClient', 'BANK_ADDED', 'disconnectBankAccounts']];
