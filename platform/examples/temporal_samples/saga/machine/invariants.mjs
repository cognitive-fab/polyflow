...
export const stateInvariants = [
  ...
  },
  {
    ...
    pred: (s) => !['undo_client', 'undo_address', 'compensated', 'compensation_failed'].includes(s.phase) || s.failedStep !== '',
  },
  {
  ...
  },
  {
    ...
    pred: (s) => !['undo_client', 'undo_address', 'compensated', 'compensation_failed'].includes(s.phase) || ['addClient', 'addBankAccount'].includes(s.failedStep),
  },
];
